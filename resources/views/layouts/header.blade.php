        ...
        <div class="flex justify-between ml-2 bg-white border-gray-200 border-red-500">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class='mr-4 md:mt-2'>
                    <img src="{{ asset('images/jpl-system-logo.png') }}" alt="profile Pic" class="h-20 w-auto md:h-20">
                ...
                @if (Route::currentRouteName() === 'vehicledetailspage' || Route::currentRouteName() === 'workingstructions' || Route::currentRouteName() === 'compliancepage' || Route::currentRouteName() === 'partlistpage' || Route::currentRouteName() === 'supplierspage')
                    <div
                        class="flex items-center justify-center h-10 mt-5 transition-colors duration-300 bg-black rounded-sm w-44 hover:bg-black">
            ...
            @if (Route::currentRouteName() === 'buildpage')
                <div class="items-center flex justify-center hover:text-orange-700 transition duration-500 md:mr-2">
                    <div class="flex items-center justify-center  md:mr-1">
                        <i class="fa-regular fa-rectangle-xmark"></i>
                    </div>

                    <div class="class=" flex items-center justify-center h-10 mt-5 transition-colors duration-300 bg-black
                        rounded-sm w-44 hover:bg-black">
                        <a href="{{ route('dashboard') }}"
                            class="text-black w-full h-16 flex justify-end items-center  hover:text-orange-500 transition duration-500">Dashboard</a>
                    </div>
                </div>
            @endif
