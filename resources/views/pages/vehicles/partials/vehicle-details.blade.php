        ...
        <section class='py-8'>
            <div class="w-full">
                ...
                <div class="grid grid-cols-1 xl:grid-cols-12 gap-6 w-full relative min-h-[400px]">
                            ...
                            <div class="flex flex-col lg:flex-row items-stretch h-full">
                                ...
                                <div class="w-full lg:w-7/12 p-8 flex flex-col justify-start">
                                    <div class="flex items-center gap-4 mb-8 flex-shrink-0">
                                        ...
                                        <div>
                                            <h3 class="text-xl font-bold text-gray-900">{{ $category->name }} Specifications</h3>
                                            <p class="text-sm text-gray-500 mt-1">Purpose-built. Performance-driven.</p>
                                        </div>
                                    </div>
                    ...
                    <div class="xl:col-span-3 flex flex-col self-start w-full">
                        <div class="bg-white rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-200 p-6 flex flex-col">
                            <div class="flex items-center gap-2 mb-6">
                                <svg class="w-4 h-4 text-[#b4975a]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                                <h2 class="text-[#b4975a] font-bold text-xs uppercase tracking-widest">At A Glance</h2>
                            </div>
                            
                            <div class="space-y-6">
                                <div class="flex items-start gap-4">
                                    <div class="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0 bg-gray-50 border border-gray-100 text-[#b4975a]">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
                                    </div>
                                    <div>
                                        <h4 class="text-sm font-bold text-gray-900">Exclusive Build</h4>
                                        <p class="text-xs text-gray-500 mt-1">No two vehicles alike</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 class="text-sm font-bold text-gray-900">Precision Engineering</h4>
                                        <p class="text-xs text-gray-500 mt-1">Engineered for performance</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 class="text-sm font-bold text-gray-900">Custom Spec</h4>
                                        <p class="text-xs text-gray-500 mt-1">Your vision, our build</p>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <div>
                                        <h4 class="text-sm font-bold text-gray-900">Hand-Built</h4>
                                        <p class="text-xs text-gray-500 mt-1">Crafted with expertise</p>
                                    </div>
                                </div>
                            </div>
                        </div>
