...
/* MAIN */
#jpl-main{flex:1;min-width:0;padding:32px 48px 100px;max-width:1200px;margin:0 auto;}
...
function render(){
    ...
    html+=`<div class="stage-heading">Hazards & Controls</div><table class="hazard-table"><thead><tr><th>Hazard</th><th>Control</th></tr></thead><tbody>`;
    op.hazards.forEach(([h2,c])=>{html+=`<tr><td class="haz">${e(h2)}</td><td class="ctrl">${e(c)}</td></tr>`});html+=`</tbody></table>`;
    ...
    html+=`<div class="stage-heading">Quality Check Points</div><table class="qc-table"><thead><tr><th>Check</th><th>Accept Criteria</th><th>Result</th></tr></thead><tbody>`;
