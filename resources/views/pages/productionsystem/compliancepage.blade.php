                            ...
                            @foreach ($adrData as $adr)
                                <tr class="bg-white border-b border-gray-900">
                                    ...
                                    @else
                                        ...
                                        <td class="px-2 py-2">
                                            <div class="flex flex-col items-center justify-center w-32 p-2 border-2 border-gray-300 border-dashed rounded-md cursor-pointer h-36 "
                                                ...
                                                <h3 class="text-sm text-center text-gray-500" style=>drag and drop, or browse
                                                    your file</h3>
                                            ...
                                            <div>
                                                ...
                                                <div class="flex flex-col items-start mt-1 space-y-1">
                                                    ...
                                                    <div class="flex items-center space-x-1">
                                                        ...
                                                        <input type="text" placeholder=""
                                                            class="h-8 border border-black w-14 ">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <td class="px-2 py-2">
                                        <div class="flex flex-col items-center justify-center">
                                            <button type="submit"
                                                class="text-gray-900 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800">Save
                                            </button>
                                            <button type="submit"
                                                class="text-gray-900 hover:text-white border border-gray-800 hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 dark:border-gray-600 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-800">Edit
                                            </button>
                                            <button type="submit"
