        ...
        <section class="py">
            <div class="container px-6 mx-auto">
                ...
                <div class="flex justify-center items-center p-2 mb-16 w-[40%] mx-auto">
                    <input type="text" id="searchInput" placeholder="Search Specific attribute..." class="flex-grow p-2"
                        style="h-[40%]">
                ...
                <div>
                    <div>
                        ...
                        <div class="overflow-hidden bg-white shadow-md justify-betweenw-5xl">
                                                ...
                                                <table class="w-full text-sm bg-white rounded shadow-md ">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="px-2 py-2 border-b border-black"> 1,513
                                                                mm
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="px-2 py-2 border-b border-black ">1507 -
                                                                1513
                                                                - 1,513 mm</td>
                                                        ...
                                                        <tr>
                                                            <td class="px-2 py-2 border-b border-black ">Wheel
                                                                Base</td>
                                                            <td class="px-2 py-2 border-b border-black"> 2,760
                                                                mm</td>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td class="px-2 py-2 border-b border-black ">Max
                                                                    ...
                                                                    Load,
                                                                    braked</td>
                                                                <td class="px-2 py-2 border-b border-black"> 12%
                                                                    1670 -
                                                                    1905 kg</td>
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                document.querySelectorAll('nav a').forEach(link => {
                                    link.addEventListener('click', function(event) {
                                        ...
                                        const tabId = this.getAttribute('href').substring(
                                        1); // Get tab ID from href attribute
                                        ...
                                        xhr.onreadystatechange = function() {
                                            if (xhr.readyState === XMLHttpRequest.DONE) {
                                                if (xhr.status === 200) {
                                                    ...
                                                    document.getElementById('ajax-container').innerHTML = xhr
                                                        .responseText;
                                        ...
                                        xhr.open('GET', 'tab_contents/' + tabId + '.html',
                                        true); // Adjust the path as needed
                                        xhr.send();
                                    });
                                });

                                // Show the Engine & Performance tab by default
                                showTab('engine');
                            });
                            ...
                            function showTab(tabId) {
                                ...
                                // Add active class to the Engine & Performance tab by default
                                const engineLink = document.querySelector('nav a[href="#engine"]');
                                if (tabId === 'engine') {
                                    engineLink.classList.add('active');
                                } else {
                                    engineLink.classList.remove('active');
                                }
                            }
                        </script>
        </section>
