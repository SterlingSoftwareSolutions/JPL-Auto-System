...
<div class="flex justify-start items-start gap-5 bg-white">
    @if(Route::currentRouteName() === 'vehicledetailspage')
      <a href="#"  class="text-white w-44 h-16 flex justify-center items-center font-bold bg-black hover:bg-black hover:text-white transition duration-1000">  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-ev-front mr-2" viewBox="0 0 16 16">
    ...
    @if(Route::currentRouteName() === 'workingstructions')
        <a href="#" class="text-white w-44 h-16 flex justify-center items-center font-bold bg-black hover:bg-black hover:text-white transition duration-1000"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-megaphone mr-2" viewBox="0 0 16 16">
    ...
    @if(Route::currentRouteName() === 'compliancepage')
        <a href="#" class="text-white w-44 h-16 flex justify-center items-center font-bold bg-black hover:bg-black hover:text-white transition duration-1000"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-brightness-high mr-2" viewBox="0 0 16 16">
    ...
    @if(Route::currentRouteName() === 'partlistpage')
        <a href="#" class="text-white w-44 h-16 flex justify-center items-center font-bold bg-black hover:bg-black hover:text-white transition duration-1000"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-list-stars mr-2" viewBox="0 0 16 16">
    ...
    @if(Route::currentRouteName() === 'supplierspage')
        <a href="#" class="text-white w-44 h-16 flex justify-center items-center font-bold bg-black hover:bg-black hover:text-white transition duration-1000"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
